...
ashe = [
    "Ashe",
    {
        ...
        "Dynamite Burn Damage per Second" : "20",
...
echo = [
    "Echo",
    {
        ...
        "Flight Duration" : "3s",
        "Flight Cooldown" : "6s",
        "Focusing Beam Damage per Second(Enemy has more than half HP)" : "50",
        "Focusing Beam Damage per Second(Enemy has less than half HP)" : "200",
...
zarya = [
    "Zarya",
    {
        ...
        "Particle Cannon Base Damage per Second" : "95",
